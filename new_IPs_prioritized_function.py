...
def rate_IPs_all_time_new_important(list_of_flows):
        ...
        for flow in list_of_flows:
            ...
            if (current_time - last_event) < 86400:
                ...
                time_modifier_factor = (current_time - first_event) // 86400
                # I am using the general function y = x/(x + 10), where x is the number of days since an IP was first seen.
                # In this way, the amount by which a score will decrease will increase to about 50% in about 10 days,
